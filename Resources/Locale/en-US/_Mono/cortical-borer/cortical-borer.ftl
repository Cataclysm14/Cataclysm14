...
cortical-borer-ghostrole-rules = Lay your eggs, and spread your hive, but killing is not the top of the priority list. And if you kill for no reason, expect retaliation from above. An addtion to this, you may [head=3][color=#04bf5e]INFECT[/color][/head] in [color=#e8d905]Colonial Outpost[/color] or [color=#2093b0]Medical Dispatch[/color] but killing in these locations is [head=3][color=#e00d26]FORBIDDEN![/color][/head](RDM as a borer will result in a [color=#e00d26]24 hour server ban[/color], often wordlessly, so if you kill someone there better be a reason)
