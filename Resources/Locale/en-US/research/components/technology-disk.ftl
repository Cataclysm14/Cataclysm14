...
tech-disk-ui-print-1K-button = Print Point Disk ({$amount})
tech-disk-ui-print-5K-button = Print Point Disk ({$amount})
tech-disk-ui-print-10K-button = Print Point Disk ({$amount})
