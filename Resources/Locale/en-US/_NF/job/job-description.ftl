job-description-bailiff = Second in command to the Colonel, ensure order at the flagship, watch over your Fireteam leader(s), and make sure that all ASR insurgents are executed for their crimes against the TSF.
