...
game-ticker-player-join-game-message = Welcome to Cataclysm 14! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC (usually available only between rounds).
game-ticker-get-info-text = Hi and welcome to [color=white]Cataclysm 14![/color]
                            The current round is: [color=white]#{$roundId}[/color]
                            The current player count is: [color=white]{$playerCount}[/color]
                            The current map is: [color=white]{$mapName}[/color]
                            The current game mode is: [color=white]{$gmTitle}[/color]
                            >[color=yellow]{$desc}[/color]
game-ticker-get-info-preround-text = Hi and welcome to [color=white]Cataclysm 14![/color]
                            The current round is: [color=white]#{$roundId}[/color]
...
latejoin-arrival-announcement = {$character} ({$job}) { CONJUGATE-HAVE($entity) } arrived at the cataclysm!
latejoin-arrival-announcement-special = {$job} {$character} on deck!
latejoin-arrival-sender = Clarksville
